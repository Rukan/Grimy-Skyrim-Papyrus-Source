...
STATE FISS_SAVE_PRESET
	...
	EVENT OnHighlightST()
		SetInfoText("Saves your SkyUI settings to a FISS xml file.")
	ENDEVENT
ENDSTATE
...
STATE FISS_LOAD_PRESET
	EVENT OnSelectST()
		IF ShowMessage("Are you sure you want load a preset?")
			FISS_LOAD()
			ShowMessage("Done Loading Preset, you may want to swap tabs to refresh your settings icons")
		ENDIF
	ENDEVENT
	
	EVENT OnHighlightST()
		SetInfoText("Loads your SkyUI settings from a FISS xml file if one exists.")
	ENDEVENT
ENDSTATE
...
FUNCTION FISS_LOAD()
	...
	IF fiss.loadBool("fissExists")
		...
		SKI_ActiveEffectsWidgetInstance.Enabled = fiss.loadBool("SKI_ActiveEffectsWidgetInstance.Enabled")
		_effectWidgetIconSizeIdx = fiss.loadInt("_effectWidgetIconSizeIdx")
		SKI_ActiveEffectsWidgetInstance.MinimumTimeLeft = fiss.loadInt("SKI_ActiveEffectsWidgetInstance.MinimumTimeLeft")

		SKI_FavoritesManagerInstance.ButtonHelpEnabled = fiss.loadBool("SKI_FavoritesManagerInstance.ButtonHelpEnabled")
		...
		SKI_FavoritesManagerInstance.GroupAddKey = fiss.loadInt("SKI_FavoritesManagerInstance.GroupAddKey")
		SKI_FavoritesManagerInstance.GroupUseKey = fiss.loadInt("SKI_FavoritesManagerInstance.GroupUseKey")
		SKI_FavoritesManagerInstance.SetIconKey = fiss.loadInt("SKI_FavoritesManagerInstance.SetIconKey")
		SKI_FavoritesManagerInstance.SaveEquipStateKey = fiss.loadInt("SKI_FavoritesManagerInstance.SaveEquipStateKey")
		SKI_FavoritesManagerInstance.ToggleFocusKey = fiss.loadInt("SKI_FavoritesManagerInstance.ToggleFocusKey")

		SKI_FavoritesManagerInstance.SetGroupHotkey(0, fiss.loadInt("groupHotkeys[0]") )
		SKI_FavoritesManagerInstance.SetGroupHotkey(1, fiss.loadInt("groupHotkeys[1]") )
		SKI_FavoritesManagerInstance.SetGroupHotkey(2, fiss.loadInt("groupHotkeys[2]") )
		SKI_FavoritesManagerInstance.SetGroupHotkey(3, fiss.loadInt("groupHotkeys[3]") )
		SKI_FavoritesManagerInstance.SetGroupHotkey(4, fiss.loadInt("groupHotkeys[4]") )
		SKI_FavoritesManagerInstance.SetGroupHotkey(5, fiss.loadInt("groupHotkeys[5]") )
		SKI_FavoritesManagerInstance.SetGroupHotkey(6, fiss.loadInt("groupHotkeys[6]") )
		SKI_FavoritesManagerInstance.SetGroupHotkey(7, fiss.loadInt("groupHotkeys[7]") )

		_3DItemXOffset = fiss.loadFloat("_3DItemXOffset")
		_3DItemYOffset = fiss.loadFloat("_3DItemYOffset")
		_3DItemFlags = fiss.loadInt("_3DItemFlags")
		...
		SKI_ActiveEffectsWidgetInstance.GroupEffectCount = fiss.loadInt("SKI_ActiveEffectsWidgetInstance.GroupEffectCount")
		...
		SKI_MainInstance.MapMenuCheckEnabled = fiss.loadBool("SKI_MainInstance.MapMenuCheckEnabled")
		SKI_MainInstance.FavoritesMenuCheckEnabled = fiss.loadBool("SKI_MainInstance.FavoritesMenuCheckEnabled")
		SKI_MainInstance.InventoryMenuCheckEnabled = fiss.loadBool("SKI_MainInstance.InventoryMenuCheckEnabled")
		SKI_MainInstance.MagicMenuCheckEnabled = fiss.loadBool("SKI_MainInstance.MagicMenuCheckEnabled")
		SKI_MainInstance.BarterMenuCheckEnabled = fiss.loadBool("SKI_MainInstance.BarterMenuCheckEnabled")
		SKI_MainInstance.ContainerMenuCheckEnabled = fiss.loadBool("SKI_MainInstance.ContainerMenuCheckEnabled")
		SKI_MainInstance.CraftingMenuCheckEnabled = fiss.loadBool("SKI_MainInstance.CraftingMenuCheckEnabled")
		SKI_MainInstance.GiftMenuCheckEnabled = fiss.loadBool("SKI_MainInstance.GiftMenuCheckEnabled")
...
FUNCTION FISS_SAVE()
	...
	fiss.beginSave("SkyUI.xml","SkyUI")
	
	fiss.saveBool("fissExists",true)
	fiss.saveInt("_itemlistFontSizeIdx", _itemlistFontSizeIdx)
	fiss.saveInt("_itemlistQuantityMinCount", _itemlistQuantityMinCount)
	fiss.saveInt("_categoryIconThemeIdx", _categoryIconThemeIdx)
	fiss.saveBool("_itemlistNoIconColors", _itemlistNoIconColors)

	fiss.saveBool("SKI_ActiveEffectsWidgetInstance.Enabled", SKI_ActiveEffectsWidgetInstance.Enabled)
	fiss.saveInt("_effectWidgetIconSizeIdx", _effectWidgetIconSizeIdx)
	fiss.saveInt("SKI_ActiveEffectsWidgetInstance.MinimumTimeLeft", SKI_ActiveEffectsWidgetInstance.MinimumTimeLeft)

	fiss.saveBool("SKI_FavoritesManagerInstance.ButtonHelpEnabled", SKI_FavoritesManagerInstance.ButtonHelpEnabled)
	...
	fiss.saveInt("SKI_FavoritesManagerInstance.GroupAddKey", SKI_FavoritesManagerInstance.GroupAddKey)
	fiss.saveInt("SKI_FavoritesManagerInstance.GroupUseKey", SKI_FavoritesManagerInstance.GroupUseKey)
	fiss.saveInt("SKI_FavoritesManagerInstance.SetIconKey", SKI_FavoritesManagerInstance.SetIconKey)
	fiss.saveInt("SKI_FavoritesManagerInstance.SaveEquipStateKey", SKI_FavoritesManagerInstance.SaveEquipStateKey)
	fiss.saveInt("SKI_FavoritesManagerInstance.ToggleFocusKey", SKI_FavoritesManagerInstance.ToggleFocusKey)

	int[] groupHotkeys = SKI_FavoritesManagerInstance.GetGroupHotkeys()
	
	fiss.saveInt("groupHotkeys[0]", groupHotkeys[0])
	fiss.saveInt("groupHotkeys[1]", groupHotkeys[1])
	fiss.saveInt("groupHotkeys[2]", groupHotkeys[2])
	fiss.saveInt("groupHotkeys[3]", groupHotkeys[3])
	fiss.saveInt("groupHotkeys[4]", groupHotkeys[4])
	fiss.saveInt("groupHotkeys[5]", groupHotkeys[5])
	fiss.saveInt("groupHotkeys[6]", groupHotkeys[6])
	fiss.saveInt("groupHotkeys[7]", groupHotkeys[7])

	fiss.saveFloat("_3DItemXOffset", _3DItemXOffset)
	fiss.saveFloat("_3DItemYOffset", _3DItemYOffset)
	fiss.saveInt("_3DItemFlags", _3DItemFlags)
	fiss.saveBool("_3DItemDisablePositioning", _3DItemDisablePositioning)
	...
	fiss.saveInt("SKI_ActiveEffectsWidgetInstance.GroupEffectCount", SKI_ActiveEffectsWidgetInstance.GroupEffectCount)
	fiss.saveFloat("_effectWidgetXOffset", _effectWidgetXOffset)
	fiss.saveFloat("_effectWidgetYOffset", _effectWidgetYOffset)

	fiss.saveInt("_itemcardAlignIdx", _itemcardAlignIdx)
	fiss.saveFloat("_itemcardXOffset", _itemcardXOffset)
	fiss.saveFloat("_itemcardYOffset", _itemcardYOffset)

	fiss.saveBool("SKI_MainInstance.MapMenuCheckEnabled", SKI_MainInstance.MapMenuCheckEnabled)
	fiss.saveBool("SKI_MainInstance.FavoritesMenuCheckEnabled", SKI_MainInstance.FavoritesMenuCheckEnabled)
	fiss.saveBool("SKI_MainInstance.InventoryMenuCheckEnabled", SKI_MainInstance.InventoryMenuCheckEnabled)
	fiss.saveBool("SKI_MainInstance.MagicMenuCheckEnabled", SKI_MainInstance.MagicMenuCheckEnabled)
	fiss.saveBool("SKI_MainInstance.BarterMenuCheckEnabled", SKI_MainInstance.BarterMenuCheckEnabled)
	fiss.saveBool("SKI_MainInstance.ContainerMenuCheckEnabled", SKI_MainInstance.ContainerMenuCheckEnabled)
	fiss.saveBool("SKI_MainInstance.CraftingMenuCheckEnabled", SKI_MainInstance.CraftingMenuCheckEnabled)
	fiss.saveBool("SKI_MainInstance.GiftMenuCheckEnabled", SKI_MainInstance.GiftMenuCheckEnabled)
...
;INT FUNCTION GetQuantityMin()
;	RETURN _itemlistQuantityMinCount
;ENDFUNCTION

;FUNCTION SetQuantityMin(INT newMin)
;	_itemlistQuantityMinCount = newMin
;	SKI_SettingsManagerInstance.SetOverride("ItemList$quantityMenu$minCount", _itemlistQuantityMinCount)
;ENDFUNCTION 