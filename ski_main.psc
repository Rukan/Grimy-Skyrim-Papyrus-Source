...
function Error(Int a_errId, String a_msg)
	...
	debug.MessageBox("SKYUI ERROR CODE " + a_errId as String + "\n\n" + a_msg + "\n\nFor more help, visit the SkyUI Nexus or Workshop pages.")
	ErrorDetected = true
endFunction
